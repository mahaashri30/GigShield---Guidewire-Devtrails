...
import 'package:susanoo/screens/admin/admin_dashboard_screen.dart';
...
class _AuthListenable extends ChangeNotifier {
  ...
  bool get isAdmin => _ref.read(authProvider).isAdmin;
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      if (isLoggedIn) {
        if (isAdmin) {
          if (onAuth || loc == '/home') return '/admin/dashboard';
          return null;
        }
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final asAdmin = extra['asAdmin'] as bool? ?? false;
          return OtpScreen(phone: phone, asAdmin: asAdmin);
        },
      ),
      GoRoute(
        path: '/auth/platform',
