                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: isSelected
                            ? [BoxShadow(color: AppTheme.primary.withOpacity(0.2), blurRadius: 8, offset: const Offset(0, 3))]
                            : [],
                      ),
                      child: Text(
                        p['label']!,
  ...
  Widget _buildFetchCard() {
    switch (_fetchState) {
      ...
      case _FetchState.fetching:
        final label = AppConstants.platforms
            .firstWhere((p) => p['value'] == _selected, orElse: () => {'label': _selected!})['label']!;
        return _Card(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  _EarningStat(label: 'Avg Daily Earning', value: '₹$avg', icon: Icons.trending_up_rounded),
                  _EarningStat(label: 'Last Week Payout', value: '₹$weekly', icon: Icons.account_balance_wallet_rounded),
                  _EarningStat(label: 'Active Days', value: '$days days', icon: Icons.calendar_today_rounded),
                ],
              ),
...
class _Card extends StatelessWidget {
  ...
  final Color color;
  final Color? border;
  const _Card({super.key, required this.child, required this.color, this.border});
